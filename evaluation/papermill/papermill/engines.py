...
from .preprocess import PapermillExecutePreprocessor, ExecutionParam 
...
class NotebookExecutionManager(object):
    ...
    def cell_exception(self, cell, **kwargs):
        ...
        if "recognized_error" in kwargs:
          cell.metadata.papermill['recognized'] = kwargs['recognized_error'].message
...
class Engine(object):
    ...
    def execute_notebook(
        cls, nb, kernel_name, input_path=None, output_path=None, progress_bar=True, log_output=False, execution_param=None, **kwargs
    ):
        """
        ...
        try:
            nb = cls.execute_managed_notebook(nb_man, kernel_name, input_path=input_path, log_output=log_output, execution_param=execution_param, **kwargs)
...
class NBConvertEngine(Engine):
    ...
    def execute_managed_notebook(
        ...
        **kwargs
        ...
        """
        print("This file has {} cells, kernel = {}".format(len(nb_man.nb.cells), kernel_name))
        ...
        #)
        preprocessor = PapermillExecutePreprocessor(
            timeout=execution_param.execution_timeout,
            startup_timeout=start_timeout,
            kernel_name=kernel_name,
            input_path=input_path,
